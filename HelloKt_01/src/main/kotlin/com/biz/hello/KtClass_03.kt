...
fun main() {
    ...
    // data class를 빈 값으로 객체로 생성하려면 클래스 선언문에 default 값이
    var userVO = UserVO()
    ...
    var bookVO1 = BookVO(author = "성춘향",title = "제이쿼리",comp = "이지스",price = 12000)
    println(UserVO(name = "장보고",tel = "010-111-1111").toString())
